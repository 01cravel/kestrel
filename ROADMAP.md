...
- ✅ The page is now honestly labelled Candidate Portfolio. The original 16 holdings remain an immutable comparison baseline, while a separate deterministic selector can replace the eight direct companies only from an already frozen universe snapshot. It requires stable identity, verified membership, a positive cutoff price, at least six of eight declared company descriptors and no SEC conflict; it records the snapshot, manifest, evidence and candidate hashes and never opens a promotion gate.
