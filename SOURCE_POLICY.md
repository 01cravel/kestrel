...
| Corporate actions and total return | Exchange/issuer notices plus DTCC, normalized by a validated point-in-time service | Splits, dividends, mergers, symbol changes and delistings must be applied before return or risk calculations | The no-cost archive binds adjusted closes to raw split/dividend proofs and now appends later survivor and merger paths automatically. A delisting needs both an inactive dated listing record and timely SEC/issuer terms. Cash needs explicit per-share proceeds and ISO currency; stock needs a stable successor, conversion ratio and same-currency adjusted successor path. Missing quotes, late records, conflicting terms, absent proceeds or mixed adjustment definitions remain incomplete |
